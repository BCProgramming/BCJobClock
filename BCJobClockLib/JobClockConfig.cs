...
namespace BCJobClockLib
{
    public class JobClockConfig
    {
        ...
        public bool Client_AllowUserClick
        {
            get { return OurINI["Client.Settings"]["AllowUserClick"].GetValue(true); }
            set { OurINI["Client.Settings"]["AllowUserClick"].Value = value.ToString(); }
    ...
    /// </summary>
        ...
        public bool LogData
        {
            get { return OurINI["Admin.Settings"]["LogData", "false"].GetValue(false); }
            set { OurINI["Admin.Settings"]["LogData", "false"].SetValue(value); }
        }
